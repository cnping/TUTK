// p2pClient.cpp : Defines the class behaviors for the application.
//
...
// The one and only Cp2pClientApp object

Cp2pClientApp theApp;


// Cp2pClientApp initialization
